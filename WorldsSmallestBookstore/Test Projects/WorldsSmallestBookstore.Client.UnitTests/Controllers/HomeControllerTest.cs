...
namespace WorldsSmallestBookstore.Tests
{
    ...
    public class HomeControllerTest
    {
        ...
        public void Index()
        {
            ...
            // Assert
            Assert.AreEqual("World's Smallest Bookstore Home Page.  Look at our latest Books", result.ViewBag.Message);
        }
        ...
        [TestMethod()]
        public void BooksellerLoginTest()
        {
            HomeController target = new HomeController(); 
            //Act
            ViewResult result = target.BooksellerLogin() as ViewResult;
